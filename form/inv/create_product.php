...
<form class="form-group" method="post" action="function/inv/create_product.php" enctype="multipart/form-data">
	<input type="hidden" name="id_company" value="<?php echo $usr->userdata->id_company ?>">
	<fieldset class="col-md-6">
		<legend>Creación de Producto</legend>
		<label class="black-label">Código: </label><input type="text" name="cod_product" placeholder="Código Producto" class="form-control" maxlength="25"><br>
		<label class="black-label">Nombre del Producto: </label><input type="text" name="name" placeholder="Nombre del Producto" class="form-control" maxlength="50" required><br>
		<label class="black-label">Descripcion del Producto: </label><textarea placeholder="Descripción" name="description" class="form-control"></textarea><br>
		<label class="black-label">Precio Unitario: </label><input type="text" name="unit_price" class="form-control onlyNumber" placeholder="Precio Unitario" required><br>
		<label class="black-label">Precio de Costo: </label><input type="text" name="unit_cost" class="form-control onlyNumber" placeholder="Precio de Costo" required><br>
		<?php echo empty($session["error"]["numericValue"]) ? "" : $session["error"]["numericValue"]; ?>
		<label class="black-label"><input type="checkbox" name="active" value="1" checked> Activo</label><br>
